...
const ClientPersonas = () => {
  ...
  const fetchPersonas = async () => {
    try {
      ...
      const response = await fetch(`${config.API_URL}/personas`, {
        headers: {
  ...
  const handleDeletePersona = async (persona) => {
    try {
      const response = await fetch(`${config.API_URL}/personas/${persona._id}`, {
        method: 'DELETE',
        headers: {
  ...
  const handleResetDatabase = async () => {
    try {
      ...
      const response = await fetch(`${config.API_URL}/personas/reset`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleGenerateMore = async () => {
    try {
      ...
      const response = await fetch(`${config.API_URL}/personas/generate`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'application/json'
