...
const UserManagementView = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch(`${config.API_URL}/auth/trainees`, {
        headers: {
  ...
  const fetchScenarios = async () => {
    try {
      ...
      // Fetch all scenarios
      const scenariosResponse = await fetch(`${config.API_URL}/scenarios`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
      ...
      const assignmentsResponse = await fetch(
        `${config.API_URL}/scenario-assignments/user/${selectedUser._id}`,
        {
  ...
  const fetchAvailablePersonas = async () => {
    try {
      ...
      // Fetch all personas
      const allPersonasResponse = await fetch(`${config.API_URL}/personas`, {
        headers: {
          'Authorization': `Bearer ${token}`,
      ...
      // Fetch current assignments
      const assignmentsResponse = await fetch(
        `${config.API_URL}/persona-assignments/user/${selectedUser._id}`,
        {
          headers: { 'Authorization': `Bearer ${token}` }
        }
      );
  ...
  const handlePersonaToggle = async (personaId, isChecked) => {
    try {
      ...
      if (isChecked) {
        // Assign persona
        const response = await fetch(`${config.API_URL}/persona-assignments`, {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
        ...
        if (assignment) {
          const response = await fetch(
            `${config.API_URL}/persona-assignments/${assignment._id}`,
            {
              method: 'PUT',
              headers: {
                'Authorization': `Bearer ${token}`,
  ...
  const handleScenarioToggle = async (scenarioId, isChecked) => {
    try {
      ...
      if (isChecked) {
        // Assign scenario
        const response = await fetch(`${config.API_URL}/scenario-assignments`, {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
        ...
        if (assignment) {
          const response = await fetch(
            `${config.API_URL}/scenario-assignments/${assignment._id}`,
            {
              method: 'PUT',
              headers: {
                'Authorization': `Bearer ${token}`,
